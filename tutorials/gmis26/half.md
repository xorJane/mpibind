# Supercomputing Foundations (4-Hour Workshop)
...
Attendees will need a laptop equipped with Wi-Fi, a shell terminal, and the `ssh` program. Participants will be provided accounts to access an AWS-based HPC cluster used for demonstrations and hands-on exercises.
...
| *10:30* | *10:45* | *Break* |
| 10:45 | 12:45 | Module 3: AI-Enabled Scientific Data Analysis |
...
3. [AI-Enabled Scientific Data Analysis](https://github.com/suzannepk/anatomy_of_a_power_outage).<br>
   *Apply your HPC skills to a realistic scientific data analytics and machine learning problem.*
   ...
   This capstone module demonstrates how parallel programming, scientific data analysis, and machine learning come together to solve large-scale real-world problems using HPC.
